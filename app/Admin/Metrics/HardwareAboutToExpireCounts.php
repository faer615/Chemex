...
class HardwareAboutToExpireCounts extends Card
{
    /**
     * @param string|Closure|Renderable|LazyWidget $content
     *
     * @return HardwareAboutToExpireCounts
     */
    public function content($content): HardwareAboutToExpireCounts
    {
        ...
        $counts = HardwareRecord::whereBetween('expired', [$from, $to])->count();
