...
/*!40000 ALTER TABLE `admin_extensions`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_extensions`
    ENABLE KEYS */;

-- 正在导出表  chemex-dev.admin_extension_histories 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `admin_extension_histories`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_extension_histories`
    ENABLE KEYS */;
...
VALUES (1, 0, 1, 'Index', 'feather icon-bar-chart-2', '/', '2020-10-10 15:06:20', '2020-10-10 15:06:20'),
       ...
       (53, 0, 26, 'Maintenance Records', 'feather icon-shield', 'maintenance/records', '2020-10-10 15:06:15',
        '2020-11-03 14:23:24'),
...
/*!40000 ALTER TABLE `admin_permissions`
    DISABLE KEYS */;
INSERT INTO `admin_permissions` (`id`, `name`, `slug`, `http_method`, `http_path`, `order`, `parent_id`, `created_at`,
                                 `updated_at`)
VALUES (1, 'Auth management', 'auth-management', '', '', 1, 0, '2020-09-18 09:45:49', NULL),
...
VALUES (1, 'Administrator', 'administrator', '2020-09-18 09:45:49', '2020-09-18 09:45:49');
/*!40000 ALTER TABLE `admin_roles`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `admin_settings`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_settings`
    ENABLE KEYS */;
...
VALUES (1, 'admin', '$2y$10$0FABOJldsayevR1lGRlHSuIEVANwUN0NQ56VPZC6AMMHy3GsTL1nm', 'Administrator', NULL,
        '9FYVEHFWRSn4i5CC4QVw6DnHfc0xyPqwBJXwDEsamQqI6o7N76hezUMEVP6z', '2020-09-18 09:45:49', '2020-10-12 19:30:10'),
       (2, 'test_user1', '$2y$10$LkfJ2s63BGHYpYGU.D5JFuym6x9oE2z34JhFkqbtvSgZJQGm05Aoe', '测试用户1', NULL, NULL,
        '2020-10-04 23:40:28', '2020-10-04 23:40:28');
/*!40000 ALTER TABLE `admin_users`
    ENABLE KEYS */;
