...
DROP TABLE IF EXISTS `device_tracks`;
...
DROP TABLE IF EXISTS `hardware_records`;
...
DROP TABLE IF EXISTS `hardware_tracks`;
...
DROP TABLE IF EXISTS `software_records`;
...
DROP TABLE IF EXISTS `software_tracks`;
...
DROP TABLE IF EXISTS `vendor_records`;
